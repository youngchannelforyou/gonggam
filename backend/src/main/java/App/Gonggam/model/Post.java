...
public class Post {
    ...
    private String Post_used_budget;
    ...
    public Post(
            ...
            @JsonProperty("Used_Budget") String post_used_budget) {
    ...
    public String getPost_used_budget() {
        return Post_used_budget;
    }

    public void setPost_used_budget(String post_used_budget) {
        Post_used_budget = post_used_budget;
    }
